...
CREATE TABLE TB_PUBLISHER (
    PUB_NO NUMBER,
    PUB_NAME VARCHAR2(50) CONSTRAINT TB_PUBLISHER_PUB_NAME_NN NOT NULL,
    PHONE VARCHAR2(15),
...
CREATE TABLE TB_MEMBER (
    ...
    CONSTRAINT TB_MEMBER_TB_GENDER_CK CHECK(GENDER IN ('M', 'F')),
...
-- 6. 회원번호가 1번인 회원이 대여한 도서들의 도서명, 출판사명, 대여일, 반납 예정일을 조회하시오.
