...
-- DEPT_CODY 테이블 DEPT_ID 컬럼에 PK 제약조건 추가
...
-- DEPT_COPY 테이블에 SYS_C007173 제약조건명을 DEPT_COPY_DEPT_ID_NN으로 변경
ALTER TABLE DEPT_COPY RENAME CONSTRAINT SYS_C007173 TO DEPT_COPY_DEPT_ID_NN;
